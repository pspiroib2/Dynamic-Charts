...
public class ComboLeg implements Cloneable {
	...
	public boolean isBuy() 	{ return m_action.equals( "BUY"); }
	public void flip() 		{ m_action = isBuy() ? "SELL" : "BUY"; }
	...
	@Override public ComboLeg clone() {
		try {
			return (ComboLeg)super.clone();
		} 
