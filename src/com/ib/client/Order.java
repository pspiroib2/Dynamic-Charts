...
public class Order {
    ...
    public int m_filled = -1; // not normally set
    ...
    public int 		m_size;         // this is total order size
    public String 	m_orderType;
    public double 	m_lmtPrice;
    public double 	m_auxPrice;
    public boolean  m_autoUpdate;
    public boolean  m_hedge;
	...
	public Strike m_strike;
    
    public Contract contract() { return m_contract; }
    public boolean isBuy() { return m_side.equals( "BUY"); }
    public boolean isSell() { return m_side.equals( "SELL"); }
    public int orderId() { return m_orderId; }
    public long elapsed() { return System.currentTimeMillis() - m_lastUpdateTime; }
    public Strike strike() { return m_strike; }
    
    public void strike( Strike v) { m_strike = v; }

    public Order( Contract contract, int orderId) {
    	m_contract = contract;
    	m_orderId = orderId;
    	m_outsideRth = false;
        m_openClose	= "O";
    ...
    public boolean equals(Object p_other) {
        ...
        if (Util.StringCompare(m_side, l_theOther.m_side) != 0 ||
    ...
    @Override public String toString() {
    	String str = m_orderId + " " + m_side + " " + m_size + " " + m_contract + " " + m_orderType;
    	if( m_orderType.equals( "LMT") ) {
    		str += " " + S.fmt2a( m_lmtPrice);
    	}
    	return str;
    }
}
